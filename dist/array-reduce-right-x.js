...
if (nativeReduceR) {
  ...
  if (isWorking) {
    res = attempt.call(array_reduce_right_x_esm_castObject('abc'), nativeReduceR, function (acc, c) {
      array_reduce_right_x_esm_newArrowCheck(this, array_reduce_right_x_esm_this);
...
//# sourceMappingURL=array-reduce-right-x.js.map